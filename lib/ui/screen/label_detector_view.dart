...
import 'package:eye_light/main.dart';
import 'package:eye_light/provider/auth_provider.dart';
import 'package:eye_light/ui/screen/painter/label_detector_painter.dart';
  ...
  Future<void> processImage(InputImage inputImage) async {
    ...
    if (inputImage.inputImageData?.size != null &&
      ...
      for (final label in labels) {
        ...
        speak+='${label.label} and ';
      }

      getIt<AuthProvider>().speak(speak.substring(0,speak.length-4));
      _text = text;
      _customPaint = null;
    }
    _isBusy = false;
